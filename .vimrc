...
" Custom Commands:
"
" Put the word into single or double quote
nnoremap <leader>' viw<esc>a'<esc>bi'<esc>lel
nnoremap <leader>" viw<esc>a"<esc>bi"<esc>lel

" Exit form insert mode
inoremap jk <esc>

" Disabling ESC key
"inoremap <esc> <nop>

" Auto ident the file 'gg=G'
"autocmd BufWritePre,BufRead * :normal gg=G

" No line wrapping for html file
autocmd BufNewFile,BufRead *.html setlocal nowrap

" Commenting the line of file
...
Plug 'ap/vim-css-color'  " May be this is not working
...
" Show number of lines of the file
